...
#define TTNN_BINARY_OP_SCALAR_TENSOR_IMPL(NAME, OP_TYPE)                             \
    Tensor NAME(                                                                     \
...
#define TTNN_BINARY_OP_SCALAR_TENSOR_FAST_APPROX_IMPL(NAME, OP_TYPE)                    \
    Tensor NAME(                                                                        \
        operations::unary::ScalarVariant lhs,                                           \
        const Tensor& rhs,                                                              \
        const std::optional<const DataType>& output_dtype,                              \
...
TTNN_BINARY_OP_SCALAR_TENSOR_FAST_APPROX_IMPL(add, ADD)
...
TTNN_BINARY_OP_SCALAR_TENSOR_FAST_APPROX_IMPL(subtract, SUB)
...
TTNN_BINARY_OP_SCALAR_TENSOR_IMPL(divide, DIV)
Tensor multiply_(
    const Tensor& lhs,
    const Tensor& rhs,
    ttsl::Span<const operations::unary::EltwiseUnaryWithParam> post_activations,
